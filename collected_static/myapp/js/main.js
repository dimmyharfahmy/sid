(function ($) {
    ...
    $(function () {
        ...
        $('.nav-menu li a').each(function () { 
            ...
            if (activePage === linkPage) { 
                ...
                console.log('Active class removed from:', this.href);
            }
        });
    });
    ...
    //     // Temporarily comment out submenu handling for debugging
    //     /*
    ...
    $(document).ready(function() {
        function menuScript() {
            $('.menu-toggle').on('click', function() {
                $('.mobile-menu').toggleClass('open');
                $('.overlay').toggleClass('open');
                console.log('Menu opened'); // Debugging line
            });
        ...
        menuScript();
        console.log('Script initialized'); // Debugging line
    });
